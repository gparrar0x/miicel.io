...
export function SettingsClient({
  ...
  const tabs = [
    { id: 'general' as Tab, label: 'General', testId: 'tab-general' },
    { id: 'payment' as Tab, label: 'Payment', testId: 'tab-payment' },
    { id: 'contact' as Tab, label: 'Contact & Hours', testId: 'tab-contact' },
  ]
        ...
        <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 mt-16 lg:mt-0">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2">
              Manage your store configuration, payment methods, and business information
            </p>
          </div>
              ...
              {activeTab === 'general' && (
                <div className="space-y-6" data-testid="general-tab-content">
                  ...
                  <div>
                    ...
                    {logoFile && (
                      <div className="mb-4">
                        <p className="text-sm text-gray-600">New file: {logoFile.name}</p>
                      </div>
                    )}
                ...
                <div className="space-y-6" data-testid="payment-tab-content">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mb-3">
                      Your MercadoPago credentials are encrypted and stored securely.
                    </p>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={day} className="flex items-center gap-4">
                          <label className="w-24 text-sm text-gray-700">{day}</label>
                          <input
                            type="time"
                            value={state.open}
