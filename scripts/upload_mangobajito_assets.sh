...
# Script para subir assets de MangoBajito a Supabase Storage
# Bucket: assets
# Path: mangobajito/
...
ASSETS_DIR="/Users/gpublica/workspace/skywalking/projects/sw_commerce_mangobajito/assets"
BUCKET_NAME="assets"
TENANT_PATH="mangobajito"

echo "🥭 Subiendo assets de MangoBajito a Supabase Storage..."
echo ""
...
# Subir logo principal (logo-mangobajito.png → logo-circle.png)
upload_file "${ASSETS_DIR}/logo-mangobajito.png" "${TENANT_PATH}/logo-circle.png" "image/png"

# Subir logo texto (logo.png → logo-text.png)
upload_file "${ASSETS_DIR}/logo.png" "${TENANT_PATH}/logo-text.png" "image/png"

# Subir banner
upload_file "${ASSETS_DIR}/banner2.png" "${TENANT_PATH}/banner.png" "image/png"
